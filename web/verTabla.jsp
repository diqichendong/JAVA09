<%-- 
    Document   : verTabla
    Created on : 9 feb. 2024, 16:36:17
    Author     : AndJe
--%>
        ...
        <div style="overflow-x:auto;">
            <table>
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <th><%= zodiaco.getNumero() %></th>
                        <th><%= zodiaco.getNombre() %></th>
                        <th><%= zodiaco.getElemento() %></th>
                        <th><%= zodiaco.getDuracion() %></th>
                        <th><%= zodiaco.getDomicilio() %></th>
                        <th><%= zodiaco.getGema() %></th>
                    </tr>
                    <%
